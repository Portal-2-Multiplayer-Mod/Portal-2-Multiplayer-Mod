...
//     // foreach letter in inputstr
//     foreach (letter in inputstr) {
//         // if the letter is the same as the letter we are looking for
//         if (letter == findstr) {
//             // replace the letter with the letter we are replacing it with
//             inputstr = inputstr.
//         }
//     }
// }
...
// local MapName = FindAndReplace(MapName, "maps/", "hi")

// local StripStart = MapName.find("maps/")
// local StripEnd = MapName.find(".bsp")
// local MapName = MapName.slice(StripStart, StripEnd)

printl(MapName)

IncludeScript("mapsupport/" + MapName + ".nut")