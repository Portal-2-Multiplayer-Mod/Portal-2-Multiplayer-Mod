...
portal2.exe -window -w 1280 -h 720 -novid -allowspectators +exec multiplayermod.cfg +sv_lan 0 sv_timeout 3 +mp_wait_for_other_player_notconnecting_timeout 240 +mp_wait_for_other_player_timeout 3 +map mp_coop_lobby_3 -nosixense
rem unmount the mod
