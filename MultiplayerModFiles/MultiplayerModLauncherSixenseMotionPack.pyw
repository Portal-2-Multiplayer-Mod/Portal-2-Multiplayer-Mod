...
#
# Normal Portal 2 will start on
# this launcher when on Linux
#
# # # # # # # # # # # # # # # # # #
...
def Launch():
    ...
    try:
        if(iow):
            try:
                ...
                print("Did not fail to remove server_sixense.dll!")
            except:
                pass
            try:
    ...
    if (iow):
        try:
            ...
            print("Failed to disable server_sixense.dll!")
        try:
        ...
        try:
            ...
            print("Failed to rename server_sixense.dll")
        try:
...
# Create a window
root = tk.Tk()
root.title("Portal 2: Multiplayer Mod Launcher (Sixense MotionPack)")
