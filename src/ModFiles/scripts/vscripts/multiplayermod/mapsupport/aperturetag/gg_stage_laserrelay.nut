...
function MapSupport(MSInstantRun, MSLoop, MSPostPlayerSpawn, MSPostMapSpawn, MSOnPlayerJoin, MSOnDeath, MSOnRespawn) {
    if (MSInstantRun) {
        ...
        // Make fizzlers work
        EntFireByHandle(Entities.FindByNameNearest("@fizzler_gun_1_on", Vector(-1048, 768, 352), 32), "AddOutput", "OnTrigger !activator:RunScriptCode:updateGels(activator false true):0:-1", 0, null, null)
        EntFireByHandle(Entities.FindByNameNearest("@fizzler_gun_1_on", Vector(1212, -128, 576), 32), "AddOutput", "OnTrigger !activator:RunScriptCode:updateGels(activator true true):0:-1", 0, null, null)
        EntFireByHandle(Entities.FindByNameNearest("@fizzler_gun_1_on", Vector(-4, -128, 576), 32), "AddOutput", "OnTrigger !activator:RunScriptCode:updateGels(activator true false):0:-1", 0, null, null)
        ...
        EntFireByHandle(Entities.FindByClassnameNearest("trigger_multiple", Vector(1152, 2032, 640), 32), "AddOutput", "OnTrigger !activator:RunScriptCode:updateGels(activator false false):0:-1", 0, null, null)
