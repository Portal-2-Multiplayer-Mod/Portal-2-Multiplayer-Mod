...
function MapSupport(MSInstantRun, MSLoop, MSPostPlayerSpawn, MSPostMapSpawn, MSOnPlayerJoin, MSOnDeath, MSOnRespawn) {
    if (MSInstantRun) {
        ...
        EntFireByHandle(Entities.FindByClassnameNearest("trigger_multiple", Vector(412, -96, 704), 32), "AddOutput", "OnStartTouch !activator:RunScriptCode:UpdateGels(activator true true):0:-1", 0, null, null)
        EntFireByHandle(Entities.FindByClassnameNearest("trigger_multiple", Vector(412, -96, 704), 32), "AddOutput", "OnEndTouch !activator:RunScriptCode:UpdateGels(activator true true):0:-1", 0, null, null)

        EntFireByHandle(Entities.FindByClassnameNearest("trigger_multiple", Vector(356, -96, 704), 32), "AddOutput", "OnStartTouch !activator:RunScriptCode:UpdateGels(activator false true):0:-1", 0, null, null)
        EntFireByHandle(Entities.FindByClassnameNearest("trigger_multiple", Vector(356, -96, 704), 32), "AddOutput", "OnEndTouch !activator:RunScriptCode:UpdateGels(activator false true):0:-1", 0, null, null)
