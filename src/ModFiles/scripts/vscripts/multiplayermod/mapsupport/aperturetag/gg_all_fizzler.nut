...
function MapSupport(MSInstantRun, MSLoop, MSPostPlayerSpawn, MSPostMapSpawn, MSOnPlayerJoin, MSOnDeath, MSOnRespawn) {
    if (MSInstantRun) {
        ...
        // Make fizzlers work
        EntFireByHandle(Entities.FindByName(null, "@fizzler_A_gun_1_on"), "AddOutput", "OnTrOnStartTouchigger !activator:RunScriptCode:UpdateGels(activator false true):0:-1", 0, null, null)
        EntFireByHandle(Entities.FindByName(null, "@fizzler_A_gun_1_on"), "AddOutput", "OnEndTouch !activator:RunScriptCode:UpdateGels(activator false true):0:-1", 0, null, null)
        EntFire("@fizzler_A_gun_1_on", "AddOutput", "targetname @fizzler_A_gun_1_on_p2mmoverride")

        EntFireByHandle(Entities.FindByName(null, "@fizzler_gun_1_on"), "AddOutput", "OnStartTouch !activator:RunScriptCode:UpdateGels(activator true false):0:-1", 0, null, null)
        EntFireByHandle(Entities.FindByName(null, "@fizzler_gun_1_on"), "AddOutput", "OnEndTouch !activator:RunScriptCode:UpdateGels(activator true false):0:-1", 0, null, null)
        
        EntFire("@fizzler_A_gun_1_off", "AddOutput", "OnStartTouch !activator:RunScriptCode:UpdateGels(activator false false):0:-1")
        EntFire("@fizzler_A_gun_1_off", "AddOutput", "OnEndTouch !activator:RunScriptCode:UpdateGels(activator false false):0:-1")
        ...
        EntFire("@fizzler_gun_1_off_p2mmoverride", "AddOutput", "OnStartTouch !activator:RunScriptCode:UpdateGels(activator false false):0:-1")
        EntFire("@fizzler_gun_1_off_p2mmoverride", "AddOutput", "OnEndTouch !activator:RunScriptCode:UpdateGels(activator false false):0:-1")
        
        EntFireByHandle(Entities.FindByClassnameNearest("trigger_multiple", Vector(768, -432, 320), 32), "AddOutput", "OnStartTouch !activator:RunScriptCode:UpdateGels(activator false false):0:-1", 0, null, null)
        EntFireByHandle(Entities.FindByClassnameNearest("trigger_multiple", Vector(768, -432, 320), 32), "AddOutput", "OnEndTouch !activator:RunScriptCode:UpdateGels(activator false false):0:-1", 0, null, null)
