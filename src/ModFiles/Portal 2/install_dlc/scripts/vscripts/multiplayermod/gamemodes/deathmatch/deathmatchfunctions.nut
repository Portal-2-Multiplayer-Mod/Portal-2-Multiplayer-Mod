...
function EndDeathmatchGame() {
    ...
    EntFire("p2mm_servercommand", "command", "say Game Restarts In 4 Seconds", 4)
    EntFire("p2mm_servercommand", "command", "say Game Restarts In 3 Seconds", 5)
    EntFire("p2mm_servercommand", "command", "say Game Restarts In 2 Seconds", 6)
    EntFire("p2mm_servercommand", "command", "say Game Restarts In 1 Second", 7)
